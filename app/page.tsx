        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="border-t border-[rgba(199,0,255,0.2)] pt-12">
            ...
            <div className="text-center text-xs text-gray-500">
              <p className="mb-6">© Copyright Grubby Coin Block. All Rights Reserved.</p>
              ...
              <div className="flex justify-center gap-4">
                <a 
                  href="https://twitter.com/grubbycoinblock" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[rgba(199,0,255,0.2)] border border-[rgba(199,0,255,0.3)] hover:bg-[#c700ff] hover:text-white transition-all duration-300"
